  ...
  return (
    <div className="p-6 space-y-5 max-w-5xl">
      ...
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="sm" onClick={() => navigate('/teacher/classes')} className="gap-1.5 -ml-2">
      ...
      <div className="flex items-start justify-between">
        ...
        <Button size="sm" onClick={() => navigate('/teacher/homework/create')} className="gap-1.5">
          + New Assignment
        </Button>
      </div>
                ...
                {students.map((stu) => {
                  ...
                  return (
                    <tr
                      ...
                      onClick={() => navigate(`/teacher/students/${stu.id}`)}
                    >
