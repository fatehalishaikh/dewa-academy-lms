  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl">
      ...
      <div className="flex items-start justify-between">
        ...
        <Button size="sm" onClick={() => navigate('/student/ai-tutor')} className="gap-1.5">
        ...
        <Card className="rounded-2xl border-border lg:col-span-2">
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" className="text-xs h-7" onClick={() => navigate('/student/assignments')}>
      ...
      <Card className="rounded-2xl border-border">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <Button variant="ghost" size="sm" className="text-xs h-7" onClick={() => navigate('/student/grades')}>
              View all <ArrowRight className="w-3 h-3 ml-1" />
            </Button>
          </div>
        </CardHeader>
