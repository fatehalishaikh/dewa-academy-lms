...
const tabs = [
  { label: 'Dashboard',  to: '/curriculum/dashboard',  icon: BarChart3,    ai: true },
  { label: 'Builder',    to: '/curriculum/builder',    icon: Network,      ai: true },
  { label: 'Standards',  to: '/curriculum/standards',  icon: ShieldCheck,  ai: true },
  { label: 'Templates',  to: '/curriculum/templates',  icon: FileText,     ai: true },
  { label: 'Resources',  to: '/curriculum/resources',  icon: Library,      ai: false },
  { label: 'Review',     to: '/curriculum/review',     icon: CheckSquare,  ai: false },
]
