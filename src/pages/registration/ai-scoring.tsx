...
const scoredApps = mockApplications.filter(a => a.aiScore !== null && a.scoring !== null)
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" className="text-xs h-7 bg-primary hover:bg-primary/90">Recalculate All</Button>
            </div>
          </div>
