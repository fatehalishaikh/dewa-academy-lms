...
const navItems = [
  { label: 'Dashboard',      href: '/class-activities/dashboard',      icon: BarChart3,     ai: true  },
  { label: 'Timetable',      href: '/class-activities/timetable',      icon: CalendarDays,  ai: true  },
  { label: 'Attendance',     href: '/class-activities/attendance',     icon: UserCheck,     ai: true  },
  { label: 'Lesson Plans',   href: '/class-activities/lessons',        icon: BookOpen,      ai: true  },
  { label: 'Engagement',     href: '/class-activities/engagement',     icon: Zap,           ai: false },
  { label: 'Communications', href: '/class-activities/communications', icon: Bell,          ai: false },
]
...
export default function Layout({ children }: { children: React.ReactNode }) {
  return <ClassActivitiesLayout>{children}</ClassActivitiesLayout>
}
