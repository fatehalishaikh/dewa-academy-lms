...
const navItems = [
  { label: 'Dashboard',  href: '/reports/dashboard',  icon: LayoutGrid,    ai: true  },
  { label: 'Academic',   href: '/reports/academic',   icon: GraduationCap, ai: true  },
  { label: 'Attendance', href: '/reports/attendance', icon: UserCheck,     ai: true  },
  { label: 'Engagement', href: '/reports/engagement', icon: Zap,           ai: true  },
  { label: 'Exams',      href: '/reports/exams',      icon: FileCheck,     ai: false },
  { label: 'Builder',    href: '/reports/builder',    icon: Wrench,        ai: true  },
]
