'use client'
import { Sparkles, BookOpen, Users, ClipboardList, BarChart3, Clock, ArrowRight, CheckCircle2, AlertCircle, LayoutDashboard } from 'lucide-react'
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-xl font-bold text-foreground">
            {greeting}, {teacher?.name.split(' ').slice(1, 2)[0] ?? 'Teacher'} 👋
          </h1>
          <p className="text-sm text-muted-foreground mt-0.5">{today}</p>
        </div>
        <Button size="sm" variant="outline" onClick={() => router.push('/teacher/homework')} className="gap-1.5">
