...
Chapter 8 brings the two storylines together as the protagonist and antagonist meet unexpectedly at the archive. The tension builds as both characters realize what the other knows. The theme is revelation and consequence. "Knowing changes everything" (p. 121).`,
  ...
  // hw-009 submissions (cls-033: stu-001, stu-004, stu-012)
  {
    ...
    status: 'graded',
    grade: 30,
    feedback: 'Excellent work on binomial and normal distributions. Minor errors in Poisson section.',
    aiScore: 30,
  ...
  },
  {
    ...
    status: 'graded',
    grade: 28,
    feedback: 'Good overall. Binomial section complete. Some errors in Poisson parameter identification.',
    aiScore: 28,
    aiFeedback: 'Good overall. Binomial section complete. Some errors in Poisson parameter identification.',
    content: null,
  },
  // hw-010 submissions (cls-034: stu-002, stu-011)
  {
    id: 'sub-019',
    homeworkId: 'hw-010',
    studentId: 'stu-002',
    ...
    status: 'graded',
    grade: 17,
    feedback: 'Hypotheses stated correctly and test statistic calculated accurately. Conclusion could be more precise in context.',
    aiScore: 17,
    aiFeedback: 'Hypotheses correct. Test statistic accurate. Conclusion lacks full contextual interpretation.',
    content: null,
  },
  {
    id: 'sub-020',
    ...
    feedback: null,
    aiScore: 15,
    aiFeedback: 'Hypotheses stated. Minor error in test statistic calculation. Conclusion present but brief.',
    content: null,
  },
